...
public class ServerConfig {
    ...
    public boolean countFireDeaths = true;
    public boolean countDrownDeaths = true;
    public boolean countFreezeDeaths = true;
    public boolean countMagicDeaths = true;
    public boolean countSuffocationDeaths = true;
